...
_Note: This file was auto-generated from the [devcontainer-template.json](https://github.com/bare-devcontainer/templates/blob/main/src/node/devcontainer-template.json).  Add additional notes to a `NOTES.md`._
